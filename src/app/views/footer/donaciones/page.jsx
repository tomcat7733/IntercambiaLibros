    ...
    <section className="container py-5">
      <div className="row align-items-center">
        ...
        <div className="col-lg-6 mb-4 mb-lg-0">
          <Image src="/assets/img/donaciones.jpg" alt="Donaciones de libros" width={450} height={450} className="img-fluid rounded shadow" />
        </div>
        ...
        <div className="col-lg-6">
          ...
          <p>
            ...
            asegurando que el proceso sea accesible para todos. Tu generosidad ayuda a que más personas disfruten de la
            lectura.
          </p>
          ...
          <ul className="list-unstyled">
            ...
            <li className="d-flex align-items-start mb-3">
              ...
              <span>
                <strong>3. Envío del libro:</strong> El receptor cubre los gastos de envío, facilitando el proceso para
                ti.
              </span>
            </li>
          </ul>
