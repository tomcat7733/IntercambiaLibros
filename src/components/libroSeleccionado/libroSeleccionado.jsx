      ...
      <div className="custom-rectangle bg-secondary ms-5 rounded-top">
        <div className="row">
          <div className="col-12 col d-flex flex-column align-items-center h-100 mt-5 mb-4">
            <img src="../../public/assets/img/Portada3.png" className="rounded" alt="logo" width={225} height={300} />
          </div>
        </div>
        <div className="row">
    ...
    <div className="col-5 col">
      <div className="container mt-5 pt-4">
        ...
        <p className="fw-semibold mt-5">
          "¡Gracias por elegir el intercambio de libros! Al dar una nueva vida a este libro, estás ayudando a reducir el
          desperdicio y a cuidar el medio ambiente. Juntos fomentamos la reutilización, apoyamos la sostenibilidad y
          construimos una comunidad más consciente."
        </p>
        <p>🌱📚</p>
      </div>
      <div className="container d-flex align-items-center justify-content-center gap-2 mt-5">
        <button type="button" className="btn btn-outline-danger rounded-circle border-0">
          <img src="../../public/assets/icons/Cupid.gif" alt="Icono de corazón" style={{ width: 50, height: 50 }} />
        </button>
          ...
          <div className="d-flex flex-column me-3 pt-5 mt-4">
            ...
            <div className="d-flex justify-content-between align-items-center">
              <div className="d-flex">
                <img
                  src="../../public/assets/icons/icons8-estrella-48.png"
