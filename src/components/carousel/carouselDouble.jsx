<div className="container-fluid">
  <div id="carouselDonations" className="carousel slide">
    ...
    <div className="carousel-inner">
      ...
      <button className="carousel-control-prev" type="button" data-bs-target="#carouselDonations" data-bs-slide="prev">
        <span className="carousel-control-prev-icon" aria-hidden="true" />
        <span className="visually-hidden">Previous</span>
      </button>
      <button className="carousel-control-next" type="button" data-bs-target="#carouselDonations" data-bs-slide="next">
